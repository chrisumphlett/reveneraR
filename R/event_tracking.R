...
event_tracking <- function(rev_product_ids, rev_session_id, rev_username, event_type, product_properties_df, desired_properties, installed_start_date, installed_end_date) {
